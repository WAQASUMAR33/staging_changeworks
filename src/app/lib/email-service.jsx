  ...
  async sendWelcomeEmail({ donor, organization, dashboardLink }) {
    ...
    const html = `
      ...
      <body>
        <div class="container">
          <div class="header">
            ${organization.imageUrl ? `<img src="${process.env.IMAGE_BACK_URL}/${organization.imageUrl}" alt="${organization.name} Logo" class="logo" style="max-width: 150px; height: auto; margin-bottom: 20px;">` : `<img src="${process.env.NEXT_PUBLIC_BASE_URL || 'https://app.changeworksfund.org'}/imgs/changeworks.jpg" alt="ChangeWorks Logo" class="logo">`}
